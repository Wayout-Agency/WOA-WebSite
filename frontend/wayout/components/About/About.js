        ...
        <div className={styles.infoTeamTextWrapper}>
          <div className={styles.infoTeam}>
            ...
            <p className={styles.infoTeamText}>
              Мы занимаемся организацией выпускных и созданием альбомов по всей
              России. Даже в ее самых далеких уголках. Нам удалось достичь
              такого результата путем внедрения современных технологий и
              автоматизации типичных задач.
            </p>
          </div>
          <div className={styles.infoTeamRight}>
            <h2>Цель</h2>
            <p className={styles.infoTeamText}>
              Сделать качественные альбомы и выпускные доступными для детей на
              территории всей нашей великой и необъятной.
            </p>
          </div>
        </div>
