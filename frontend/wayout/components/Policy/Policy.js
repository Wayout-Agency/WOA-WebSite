...
const Policy = () => {
  return (
    <>
      <MainTitle text={"Политика конфиденциальности"} />
        ...
        <div className={styles.content}>
          <div className={styles.contentText}>
            ...
            <p>
              ...
              предпринимаемые ИП Бабаян Денис Маркович (далее &ndash; Оператор).
            </p>
            <p>
            ...
            <p>
              ...
              веб-сайта&nbsp;
              <a href="https://wayout.agency">https://wayout.agency</a>.
            </p>
            <p>&nbsp;</p>
            ...
            <p>
              &ndash; заключение, исполнение и прекращение гражданско-правовых
              договоров.
            </p>
            <p>
              ...
              адрес электронной почты hello@wayout.agency с пометкой
            ...
            <p>
              ...
              https://wayout.agency или направленные Оператору посредством
            ...
            <p>
              ...
              Оператора hello@wayout.agency с пометкой &laquo;Актуализация
            ...
            <p>
              ...
              hello@wayout.agency с пометкой &laquo;Отзыв согласия на обработку
              персональных данных&raquo;.
            </p>
            <p>
